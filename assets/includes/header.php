...
<html lang="en">
  <head>
    <title>Early Market | "Getting products to you sharp, sharp!!"</title>
    <meta charset="utf-8">
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div class="site-logo">
                <a href="index" class="js-logo-clone">
              ...
              <div class="site-top-icons">
                <ul>
                  <?php if (!isset($_SESSION['user'])) { ?>
                    <li><a href="signin"><span class="icon icon-person"></span> Login/Signup</a></li>
                  <?php }else{ ?>
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="assets/config/logout">Logout</a>
                      </ul>
                    </li>
                    <li>
          ...
          <ul class="site-menu js-clone-nav d-none d-md-block">
            ...
            <li class="has-children">
              ...
              <?php
                ...
                ?>
                <li><a href="#"><?php echo ucwords($row['cat_name']); ?></a></li>
                <?php } ?>
              </ul>
            </li>
